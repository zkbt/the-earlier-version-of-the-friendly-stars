'''
This module was stolen almost exactly from
https://github.com/dstndstn/astrometry.net/blob/master/net/client/client.py
as a wrapper for interacting with the
astrometry.net API.

Any usage of this should cite the generous efforts
of the astrometry.net team, as described at
...
# the-friendly-stars: change __main__ to a function we can call
def run_astrometry_dot_net(arguments_as_strings):
    print("Running with args %s"%arguments_as_strings)
    import optparse
    ...
    # the-friendly-stars: pass arguments as strings intead of sys.argv
    opt,args = parser.parse_args(arguments_as_strings)
...
if __name__ == '__main__':
    arguments_as_strings = sys.argv
    run_astrometry_dot_net(arguments_as_strings)
